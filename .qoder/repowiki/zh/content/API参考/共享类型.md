...
**本节来源**  
- [index.ts](file://packages/shared/types/index.ts#L84-L94)
...
- [index.ts](file://packages/web-lite/src/types/index.ts#L63-L69)
...
**本节来源**  
- [index.ts](file://packages/shared/types/index.ts#L157-L165)

### UserProfile 分析

`UserProfile` 接口在 `web-pro` 的 `types/index.ts` 中定义，描述了用户的基本信息，包括 ID、姓名、邮箱、头像、角色、权限、登录时间和创建时间。角色限定为 'admin'、'member'、'viewer' 三种，权限以字符串数组形式存储。该类型与共享模块中的 `User` 接口类似，但字段更精简，适用于轻量级用户信息展示场景。

**本节来源**  
- [index.ts](file://packages/web-pro/src/types/index.ts#L128-L137)
...
**本节来源**  
- [index.ts](file://packages/shared/types/index.ts#L236-L246)
- [index.ts](file://packages/web-pro/src/types/index.ts#L228-L243)
- [team.ts](file://packages/web-full/src/stores/team.ts#L27-L34)
...
**图示来源**  
- [index.ts](file://packages/shared/types/index.ts)
- [go.mod](file://packages/shared/package.json)
